...
type FixturesSectionListProps = {
    children: (fixture: Types) => ReactNode;
};

const FixturesSectionList = ({children}: FixturesSectionListProps) => {
    const [state, setState] = React.useState([]);
    const [query, {loading, data, error, called}] = useLazyQuery(SEARCH_GROUP_FIXTURES);
    React.useEffect(() => {
